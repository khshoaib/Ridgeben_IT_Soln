          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="content_wrap">
                ...
                <p>
                We offer a wide range of services, including sophisticated web application development, specifically designed to improve user experience and optimise routine workflows.
                </p>
            ...
            <section class="software_company_hero_section1 xb-hidden">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="service_block_2">
                                <div class="service_icon">
                                    <img src="{{url('frontend/assets/images/icons/icon_code.svg')}}"
                        ...
                        <div class="col-lg-4">
                            <div class="service_block_2">
                                <div class="service_icon">
                                    <img src="{{url('frontend/assets/images/icons/icon_monitor_2.svg')}}"
                                        alt="Ridgeben - Service icon">
                                </div>
                                <h3 class="service_title">
                        ...
                        <div class="col-lg-4">
                            <div class="service_block_2">
                                <div class="service_icon">
                                    <img src="{{url('frontend/assets/images/icons/icon_phone.svg')}}"
                                        alt="Ridgeben - Service icon">
                                </div>
                                <h3 class="service_title">
                        ...
                        <div class="col-lg-4">
                            <div class="service_block_2">
                                <div class="service_icon">
                                    <img src="{{url('frontend/assets/images/icons/icon_bug.svg')}}"
                                        alt="Ridgeben - Service icon">
                                </div>
                                <h3 class="service_title">
                        ...
                        <div class="col-lg-4">
                            <div class="service_block_2">
                                <div class="service_icon">
                                    <img src="{{url('frontend/assets/images/icons/icon_programming.svg')}}"
                                        alt="Ridgeben - Service icon">
                                </div>
                                <h3 class="service_title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="input_email" class="form-control" type="email" name="email"
                                                placeholder="Your Enter" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="input_company" class="form-control" type="text"
                                                name="companyname" placeholder="Your Company Name">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
